    ...
    <div style={{
      ...
      <header style={{
        ...
        <div style={{ display: 'flex', gap: '10px' }} className="nav-links">
          ...
          {currentPath !== '/challenge-alignment' && (
            <Link
              to="/challenge-alignment"
              style={{
                textDecoration: 'none',
                fontSize: '13px',
                fontWeight: 600,
      ...
      <footer style={{
        ...
        <div style={{ display: 'flex', justifyContent: 'center', gap: '16px', marginBottom: '16px', flexWrap: 'wrap' }}>
          ...
          <span style={{ color: 'var(--color-border)' }}>|</span>
          <Link to="/challenge-alignment" style={{ color: 'var(--color-text-secondary)', textDecoration: 'none', fontWeight: 600 }}>Alignment</Link>
          <span style={{ color: 'var(--color-border)' }}>|</span>
